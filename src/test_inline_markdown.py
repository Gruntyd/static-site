...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_delim_bold_double(self):
        node = TextNode("This is text with **two** bold **word**", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "**", TextType.BOLD)
        self.assertListEqual(
            [
    ...
    def test_image_extract(self):
        matches = extract_markdown_images("![obi wan](https://i.imgur.com/fJRm4Vk.jpeg)")
        self.assertListEqual(
            [("obi wan", "https://i.imgur.com/fJRm4Vk.jpeg")],
            matches
        )
    def test_url_extract(self):
        matches = extract_markdown_links("[to boot dev](https://www.boot.dev) and [to youtube](https://www.youtube.com/@bootdotdev)")
        self.assertListEqual(
